...
class EditAddress extends StatefulWidget {
  ...
  final dynamic gov_id;
  final dynamic area_id;
  EditAddress(
      {Key? key, required this.lat, required this.govs, required this.lng , required this.address, this.street, this.fullAddress, this.flat, this.block, this.build_number, this.gov_id, this.area_id, this.address_id})
      : super(key: key);
...
class _EditAddressState extends State<EditAddress> {
  ...
  dynamic _selectedValueP;
  dynamic _selectedValueAreaP;
...
// created method for getting user current location
  ...
  void initState() {
    ...
    // TODO: implement initStatese
    setState(() {
      address.text =widget.address??'';
      street.text =widget.street??'';
      fullAddress.text =widget.fullAddress??'';
      flat.text =widget.flat??'';
      build_number.text =widget.build_number??'';
      block.text =widget.block??'';
      _selectedValueP = widget.gov_id ?? null;
      _selectedValueAreaP = widget.area_id ?? null;
      _markers.clear();
      _markers.add(Marker(
        markerId: MarkerId("2"),
...
print(address.text);
                                  ...
                                  if (snapshot.hasData) {
                                    ...
                                    data["govs"].forEach((element) {
                                      if(_selectedValue != null){
                                        ...
                                        if(_selectedValueP.toString() == element["id"].toString() ){
                                          index = i;
                                        }
                                      }
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            dynamic data = await _api.edit_to_address(
                              widget.address_id,
                                address.text,
  ...
  Widget getCity(data , selectedCity)  {
    areaList.clear();
    String key = '12';
    print('ddddddd'+selectedCity.key);
    print('dataaaaaaaa'+data["govs"].toString());
    int index = 0;
    int i = 0;
    data["govs"].forEach((element) {
      if(_selectedValue.key ==  element["id"].toString()) {
        ...
        element['areas'].forEach((element2) {
          if(_selectedValueArea != null){
            ...
            if(_selectedValueArea.key == element2["id"].toString()){
              ...
              if(_selectedValueAreaP.toString() == element2["id"].toString() ){
                index = i;
              }
            }
          }
